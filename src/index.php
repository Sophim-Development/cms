...
<section id="home" class="pt-20">
  ...
  <div class="relative w-full h-64 sm:h-80 md:h-96 overflow-hidden">
    ...
    <button id="prevBtn"
      class="absolute left-2 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full hover:bg-gray-600">
      < </button>
        <button id="nextBtn"
          class="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full hover:bg-gray-600">
          >
        </button>
  </div>
</section>
...
<section id="services" class="py-10 bg-gray-100">
  <div class="container mx-auto text-center">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
      <div class="p-4">
        <svg class="w-10 h-10 sm:w-12 sm:h-12 mx-auto text-green-500 mb-4" fill="none" stroke="currentColor"
          viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9H20V4m-8 8v8m4-4H8"></path>
        </svg>
      ...
      <div class="p-4">
        <svg class="w-10 h-10 sm:w-12 sm:h-12 mx-auto text-green-500 mb-4" fill="none" stroke="currentColor"
          viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0113.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.095c-.5 0-.905.405-.905.905a3.61 3.61 0 01-.608 2.006L7 10m7-10l-1 1m-6 0l1-1">
          </path>
        </svg>
  ...
  <div class="container mx-auto px-4 flex flex-col md:flex-row items-center">
    ...
    <div class="md:w-1/2 md:pl-8">
      ...
      <p class="text-sm sm:text-base md:text-lg">
        ...
        system. The new system is to control the following information; patient information, staff, operating room
        schedules, patient invoices. These services are to be provided in an efficient, cost effective manner, with the
        goal of reducing the time and resources currently required for such tasks.<br><br>
        A significant part of the operation of any hospital involves the acquisition, management and timely retrieval of
        great volumes of information. This information typically involves; patient personal information and medical
        history, staff information, room and ward scheduling, staff scheduling, operating theater scheduling and various
        facilities waiting lists. All of this information must be managed in an efficient and cost wise manner so that
        an institution's resources may be effectively utilized HMS will automate the management of the hospital making
        it more efficient and error free. It aims at standardizing data, consolidating data ensuring data integrity and
...
<section id="gallery" class="py-10 bg-gray-100">
  <div class="container mx-auto px-4">
    ...
    <div class="flex justify-center space-x-4 mb-8">
      <button class="gallery-tab active bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600"
        data-category="all">All</button>
      <button class="gallery-tab bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-400"
        data-category="dental">Dental</button>
      <button class="gallery-tab bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-400"
        data-category="cardiology">Cardiology</button>
      <button class="gallery-tab bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-400"
        data-category="neurology">Neurology</button>
      <button class="gallery-tab bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-400"
        data-category="laboratory">Laboratory</button>
    </div>
    ...
    <div class="gallery-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="gallery-item cardiology">
        <img src="./assets/images/gallery/gallery_03.jpg" alt="Cardiology Image 1"
          class="w-full h-48 object-cover rounded-lg shadow-md">
      </div>
      <div class="gallery-item cardiology">
        <img src="./assets/images/gallery/gallery_04.jpg" alt="Cardiology Image 2"
          class="w-full h-48 object-cover rounded-lg shadow-md">
      </div>

      <!-- Neurology Images -->
      <div class="gallery-item neurology">
        <img src="./assets/images/gallery/gallery_05.jpg" alt="Neurology Image 1"
          class="w-full h-48 object-cover rounded-lg shadow-md">
      </div>
      <div class="gallery-item neurology">
        <img src="./assets/images/gallery/gallery_06.jpg" alt="Neurology Image 2"
          class="w-full h-48 object-cover rounded-lg shadow-md">
      </div>

      <!-- Laboratory Images -->
      <div class="gallery-item laboratory">
        <img src="./assets/images/gallery/gallery_09.jpg" alt="Laboratory Image 1"
          class="w-full h-48 object-cover rounded-lg shadow-md">
      </div>
      <div class="gallery-item laboratory">
        <img src="./assets/images/gallery/gallery_08.jpg" alt="Laboratory Image 2"
          class="w-full h-48 object-cover rounded-lg shadow-md">
      </div>
    </div>
  </div>
      ...
      <form action="submit_contact.php" method="POST">
        <div class="mb-4">
          ...
          <input type="text" id="name" name="name"
            class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-green-500 text-sm sm:text-base"
        ...
        <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 w-full sm:w-auto">Send
          Message</button>
      </form>
    </div>
  </div>
